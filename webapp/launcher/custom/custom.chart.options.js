		...
		initData: function() {
			...
			if (option) {
				...
				option.cdata_m_tmpl = option.cdata_m_tmpl || [
					...
					"	\"title\": \"\",",
					"	\"content\": [",
					"		\"<div class='amp-legend-container'>\",",
					"		\"<ul class='amp-legend-item'>\",",
					"		\"{row:<li><span class='amp-legend-title'>NAME</span><span class='amp-legend-value'>VALUE</span></li>}\",",
					"		\"</ul>\",",
					"		\"<ul class='amp-legend-item'>\",",
					"		\"{measure:<li><span class='amp-legend-title'>NAME</span><span class='amp-legend-value'>VALUE</span></li>}\",",
					"		\"</ul>\",",
					"			\"<div class='amp-legend-chart'>\",",
