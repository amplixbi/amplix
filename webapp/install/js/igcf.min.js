...
var $MI=function(e){this.mbase=e,this.cdef=null,this.jdbc_template={mysql:{name:"MySQL",driver:"com.mysql.jdbc.Driver",jdbc:"jdbc:mysql://db_host:db_port/db_name",validatesql:"SELECT 1",msg_db_host:"localhost",msg_db_port:"3306",msg_db_name:"amplix_meta",msg_db_user:"amplix_meta",msg_md_owner:"amplix_sample",msg_md_user:"amplix_sample"},mariadb:{name:"MariaDB",driver:"org.mariadb.jdbc.Driver",jdbc:"jdbc:mariadb://db_host:db_port/db_name",validatesql:"SELECT 1",msg_db_host:"localhost",msg_db_port:"3306",msg_db_name:"amplix_meta",msg_db_user:"amplix_meta",msg_md_owner:"amplix_sample",msg_md_user:"amplix_sample"},oracle:{name:"Oracle Thin Driver",driver:"oracle.jdbc.OracleDriver",jdbc:"jdbc:oracle:thin:@db_host:db_port:db_name",validatesql:"SELECT 1 FROM DUAL",msg_db_host:"localhost",msg_db_port:"1521",msg_db_name:"ORCL",msg_db_user:"amplix_meta",msg_md_owner:"ORCL",msg_md_user:"amplix_sample"},mssql:{name:"Microsoft MSSQL Server JDBC Driver",driver:"com.microsoft.sqlserver.jdbc.SQLServerDriver",jdbc:"jdbc:sqlserver://db_host:db_port;databaseName=db_name;integratedSecurity=false;",validatesql:"SELECT 1",msg_db_host:"localhost",msg_db_port:"1433",msg_db_name:"amplix_meta",msg_db_user:"amplix_meta",msg_md_owner:"amplix_sample",msg_md_user:"amplix_sample"},postg:{name:"PostgreSQL",driver:"org.postgresql.Driver",jdbc:"jdbc:postgresql://db_host:db_port/db_name",validatesql:"SELECT 1",msg_db_host:"localhost",msg_db_port:"5432",msg_db_name:"amplix_meta",msg_db_user:"amplix_meta",msg_md_owner:"amplix_sample",msg_md_user:"amplix_sample"},apacheembd:{name:"Embedded DB",driver:"org.apache.derby.jdbc.EmbeddedDriver",jdbc:"jdbc:derby:app_home/db_name;create=true",validatesql:"VALUES 1",msg_db_host:"",msg_db_port:"",msg_db_name:"amplix_meta",msg_db_user:"amplix_meta",msg_md_owner:"amplix_sample",msg_md_user:"amplix_sample"},cubrid:{name:"Cubrid",driver:"cubrid.jdbc.driver.CUBRIDDriver",jdbc:"jdbc:cubrid:db_host:db_port:db_name:dba::",validatesql:"SELECT 1",msg_db_host:"localhost",msg_db_port:"30000",msg_db_name:"amplix_meta",msg_db_user:"dba",msg_md_owner:"amplix_sample",msg_md_user:"dba"},tibero:{name:"Tmax Tibero",driver:"com.tmax.tibero.jdbc.TbDriver",jdbc:"jdbc:tibero:thin:@db_host:db_port:db_name",validatesql:"SELECT 1 FROM DUAL",msg_db_host:"localhost",msg_db_port:"8629",msg_db_name:"dbsvr",msg_db_user:"amplix_meta",msg_md_owner:"dbsvr",msg_md_user:"amplix_sample"}}};$MI.prototype={setLoading:function(e,a){var d=$("#loading"),s=$("#progressbar",d),r=$("#progress_gauge",s);1==e?(r.css({width:(a||100)+"%"}),d.show()):(r.css({width:"100%"}),setTimeout((function(){d.fadeOut()}),200))},updateJNDI:function(){$("#db_isjndi").is(":checked")?($("#form_db_jndi").show(),$("#form_db_jdbc").hide(),$("#dd_jdbc").hide(),$("#dd_jndi").show(),$("#msg_db_path").html("Ex) jdbc/amplix_meta")):($("#form_db_jndi").hide(),$("#form_db_jdbc").show(),$("#dd_jdbc").show(),$("#dd_jndi").hide())},updateDesc:function(){var e,a=$("#db_type").val();a&&this.jdbc_template[a]&&(e=this.jdbc_template[a],$.each(["msg_db_host","msg_db_port","msg_db_name","msg_db_user","msg_md_owner","msg_md_user"],(function(a,d){$("#"+d).html("Ex) "+(e[d]||""))})))},updateJdbcUrl:function(){var e,a,d,s=this,r=$("#db_type").val(),t="",o=this.jdbc_template[r],_=s.cdef;o&&($("#db_jdbc_driver").val(o.driver),$("#db_validatesql").val(o.validatesql),e=o.jdbc,$.each(["db_host","db_port","db_name"],(function(a,d){var r=$("#"+d);s.clearError(r),e.indexOf(d)>-1&&(r.val()?e=e.replace(d,r.val()):s.setError(r))})),_&&_.app_path&&e.indexOf("app_home")>-1&&(d=(a=_.app_path).split("\\\\"),"/"==(a=d.join("/")).charAt(a.length-1)&&(a=a.substring(0,a.length-1)),e=e.replace("app_home",_.app_path)),t=e),$("#db_jdbc_url").val(t)},getInstallStat:function(){var e=this,a=new IG$._rpc$;e.setLoading(!0),a.init(e,{ack:"sysinfo",payload:{},mbody:{},_lang_:window.useLocale},e,e.rs_getInstallStat,(function(e){e.errorcode;IG$.ShowErrorMessage(e),$("#app_home").html("<span style='color:#ff0000'>Not defined</span>")})),a.send(window.$instance)},rs_getInstallStat:function(e){var a,d=e,s=$("#sel_modules");this.cdef=e;var r;d.info.version.split("."),d.serverversion&&d.serverversion.split(".");if(d.needlogin||d.serverversion)return $(".error-desc",$("#d_error_01")).html("For security reasons this script will only work with a new and unmodified AmplixBI installation. You should either re-extract the files from the download package or consult the complete instruction."),$("#btn_start_01").remove(),void $("#d_error_01").show();if(!d.app_path)return $(".error-desc",$("#d_error_01")).html("APP_HOME location does not specified or configured with wrong place. Please check instruction and try again!"),void $("#d_error_01").show();if(s.empty(),d.modules&&$.each(d.modules,(function(e,a){var d,r,t="module_"+e,o=["<tr>",'<td><input type="checkbox" id="'+t+'"></input></td>','<td><label for="'+t+'"><span class="module_name">'+a.name+'</span><br/><span class="module_desc">'+a.desc+"</span></label></td>","</tr>"];d=$(o.join("")).appendTo(s),(r=$("#"+t,d)).bind("change",(function(e){a.selected=r.prop("checked")}))})),$("#dpage_01").hide(),$("#dpage_02").show(),$("#dpage_03").hide(),$("#main-area").scrollTop(0),d.meta_databases){for(a=d.meta_databases.length-1;a>=0;a--)if("IGCBASE"==d.meta_databases[a].name){r=d.meta_databases[a];break}r&&(d.dbtype=r.dataBaseType)}$("#app_home").html("<span style='color:#0000ff'>"+d.app_path+"</span>"),$("#s_version").html(d.info.version),d.dbconnection&&$("#db_type").val(d.dbtype)},updateCnt:function(e){var a=this,d=a.cdef,s=$("#db_isjndi").is(":checked"),r=d.meta_databases[0],t=!0;return r.is_jndi=s,$.each(e,(function(e,s){var o=$("#"+s);if(a.clearError(o),!o.val())return a.setError(o),t=!1,!1;switch(s){case"s2adminname":d.adminname=o.val();break;case"s2adminpwd":d.adminpwd=o.val();break;case"s2adminpwd_confirm":d.adminpwd!=o.val()&&(a.setError(o),t=!1);break;case"db_type":r.dataBaseType=o.val();break;case"db_jdbc_driver":r.jdbcDriver=o.val();break;case"db_jdbc_url":r.jdbcUrl=o.val();break;case"db_name":r.schemaname=o.val();break;case"db_user":case"md_user":r.userID=o.val();break;case"db_passwd":case"md_password":r.password=o.val();break;case"db_validatesql":r.validateSQL=o.val();break;case"db_path":r.db_path=o.val()}})),t},setError:function(e){$($(e.parent()).parent()).addClass("form-error")},clearError:function(e){$($(e.parent()).parent()).removeClass("form-error")},checkDatabaseCon:function(e,a){var d,s=this,r=s.cdef,t=new IG$._rpc$,o=$("#db_isjndi").is(":checked"),_=["db_type","db_host","db_port","db_jdbc_driver","db_jdbc_url","db_validatesql"],n="db_con_status";if(n=a||n,_=o?["db_type","db_path"]:e?_.concat(e):_.concat(["db_user","db_passwd"]),clearMessage(),r.meta_databases=[{}],0!=s.updateCnt(_)){if(e)switch((d=r.meta_databases[0]).dataBaseType){case"mysql":case"mariadb":case"postg":case"mssql":d.jdbcUrl.indexOf($("#db_name").val())>-1&&(d.jdbcUrl=d.jdbcUrl.replace($("#db_name").val(),$("#md_owner").val()))}s.setLoading(!0),$("#"+n).empty(),$("#"+n).hide(),t.init(s,{ack:"checkdbinfo",meta_type:"config_info",payload:{},mbody:r,_lang_:window.useLocale},s,(function(e){$("#"+n).html("Success on database connection!"),$("#"+n).fadeIn()}),(function(e){this.setLoading(!1),IG$.ShowErrorMessage(e),$("#"+n).html("<span style='color:#ff0000'>Error on database connection!</span>"),$("#"+n).fadeIn()})),t.send(window.$instance)}},doUpdate:function(){var e,a=this,d=a.cdef,s=new IG$._rpc$,r=$("#db_isjndi").is(":checked"),t=r?["db_type","db_path"]:["db_type","db_host","db_name","db_port","db_user","db_passwd"],o=r?["s2adminname","s2adminpwd","s2adminpwd_confirm"]:["db_jdbc_driver","db_jdbc_url","db_validatesql","s2adminname","s2adminpwd","s2adminpwd_confirm"],_=$("#md_user"),n=$("#md_password");if(md_owner=$("#md_owner"),md_path=$("#md_path"),clearMessage(),d.meta_databases=[{}],0!=a.updateCnt(t)&&0!=a.updateCnt(o)){for(a.clearError(md_owner),a.clearError(_),a.clearError(n),a.clearError(md_path),e=0;e<d.modules.length;e++)if(d.modules[e].selected){if(r){if(!md_path.val())return void a.setError(md_path)}else{if(!md_owner.val())return void a.setError(md_owner);if(!_.val())return void a.setError(_);if(!n.val())return void a.setError(n)}d.modules[e].schemaname=md_owner.val(),d.modules[e].db_user=_.val(),d.modules[e].db_passwd=n.val(),d.modules[e].db_path=md_path.val(),d.modules[e].db_is_jndi=r}a.setLoading(!0),s.init(a,{ack:"updateconfig",meta_type:"config_info",payload:{},mbody:d,_lang_:window.useLocale},a,a.rs_doUpdate,(function(e){this.setLoading(!1),IG$.ShowErrorMessage(e)})),s.stoploading=!1,s.send(window.$instance)}},rs_doUpdate:function(e){var a=this,d=e.step;a.totalsteps=d,a.curstep=0,a.processUpdate()},processUpdate:function(){var e=this,a=e.cdef;e.setLoading(!0,0),$.ajax({url:ig$.servlet,type:"POST",contentType:"application/json; charset=UTF-8",data:JSON.stringify({ack:"security",payload:{},mbody:{},uniquekey:IG$.getUniqueKey()}),async:!0,dataType:"json",timeout:0,error:function(){},success:function(d,s,r){var t=d.result,o=window.$instance,_=d.errorcode;t?(p1=t.p1,p2=t.p2,p1&&p2?(o.rsaPublicKeyModules=p1,o.rsaPublicKeyExpoenent=p2,o.rsa_kinfo=t.p3,setTimeout((function(){var d=IG$.encryptKey(o,[a.adminpwd]);e.encpwd=d,e.admuser=a.adminname,e.processUpdate_secure(d,e.admuser)}),10)):e.setLoading(!1)):_&&(e.setLoading(!1),IG$.ShowErrorMessage(d))}})},processUpdate_secure:function(e,a){var d=this,s=this.cdef,r=(new IG$._rpc$,d.totalsteps>0?d.curstep/d.totalsteps*100:0);d.setLoading(!0,r),$.ajax({url:ig$.servlet,type:"POST",contentType:"application/json; charset=UTF-8",data:JSON.stringify({ack:"procupdate",payload:{step:""+d.curstep++,apu:e[0],anm:a},mbody:s,meta_type:"config_info",_lang_:window.useLocale,uniquekey:IG$.getUniqueKey()}),dataType:"json",timeout:0,error:function(){},success:function(e,a,s){var r=e.result,t=e.errorcode;r?d.rs_processUpdate(r):t&&(d.setLoading(!1),IG$.ShowErrorMessage(e))}})},rs_processUpdate:function(e){var a=this;a.curstep<a.totalsteps?a.processUpdate_secure(a.encpwd,a.admuser):a.rs_updateComplete()},rs_updateComplete:function(e){this.setLoading(!1),$("#dpage_01").hide(),$("#dpage_02").hide(),$("#dpage_03").show(),$("#main-area").scrollTop(0)}};
var m$p={metadb:{}},locales={ko_KR:{L_PWD_F_CHAR:"문자로 시작해야 합니다!",L_PWD_F_NUM:"최소 한개 이상의 숫자를 사용해 주십시오!",L_PWD_F_LOW_CHAR:"최소 한개 이상의 소문자를 사용해 주십시오!",L_PWD_F_UPP_CHAR:"최소 한개 이상의 대문자를 사용해 주십시오!",L_PWD_F_SPEC_CHAR:"최소 한개 이상의 @ 특수문자를 사용해 주십시오!",L_PWD_F_WHT_SPACE:"스페이스는 허용되지 않습니다!",L_PWD_F_LEN:"최소 @ 자 이상을 사용해 주십시오!"},en_US:{L_PWD_F_CHAR:"Start of string!",L_PWD_F_NUM:"At least one digit!",L_PWD_F_LOW_CHAR:"At least one lower case!",L_PWD_F_UPP_CHAR:"At least one upper case!",L_PWD_F_SPEC_CHAR:"One or more @ special character!",L_PWD_F_WHT_SPACE:"No white space allowed!",L_PWD_F_LEN:"At least @ places!"}};function callback(e,n,t){this.thisobj=e,this.success=n,this.execute=function(e){this.success.call(this.thisobj,e,t)}}function showMessage(e,n,t,i){var a=$("#d_error_01"),o=$("#d_error_02");a.html(e),a.fadeIn(),o.html(e),o.fadeIn()}function clearMessage(){var e=$("#d_error_01"),n=$("#d_error_02");e.fadeOut(),n.fadeOut()}function goMain(){var e=ig$.mainlink+"/";document.location.href=e}function doUpdate(){var e=ig$.mi,n=new IG$.callBackObj(e,e.doUpdate);$("#main-area").scrollTop(2e4),showMessage("Continue to update the server?","Confirm",!0,n)}IG$.ShowErrorMessage=function(e,n){var t=e.detail;if("0x8f00"==e.errorcode){window.useLocale=window.useLocale||"en_US";var i=t;if(i){var a=i.split("|"),o=["<br/><p>"];$.each(a,(function(e,n){var t;if(n){n.indexOf("L_PWD_F_SPEC_CHAR_")>-1?(t=n.substring(18),n="L_PWD_F_SPEC_CHAR"):n.indexOf("L_PWD_F_LEN_")>-1&&(t=n.substring(12),n="L_PWD_F_LEN");var i=locales[window.useLocale][n];i.indexOf("@")>-1&&t&&(i=i.substring(0,i.indexOf("@"))+t+i.substring(i.indexOf("@")+1)),o.push(i+"<br/>")}})),o.push("</p>"),t=i=o.join("")}}showMessage(e.errormsg+"<br/>"+(t?"\n"+t:"")+"<br/>"+e.errorcode,"Error! ["+e.errorcode+"]",!0,null)},IG$.ShowConErr=function(e){showMessage("Error while connecting to server","Error!",!0,null)};var ig$=window.ig$||{};function init_events(){var e,n=window.location.pathname.split("/"),t=[];for(e=0;e<n.length&&"install"!=n[e];e++)t.push(n[e]);ig$.mainlink=t.join("/"),ig$.servlet=ig$.mainlink+"/servlet/ircp",ig$.mi=new $MI,$.each(["01","02"],(function(e,n){$("#tab_"+n).bind("click",(function(e){e.stopPropagation(),e.preventDefault(),$.each(["01","02"],(function(e,t){$("#tab_"+t)[t==n?"addClass":"removeClass"]("selected"),$("#tab_content_"+t)[t==n?"show":"hide"]()}))}))}));var i=$("#db_type");i.empty(),$.each(ig$.mi.jdbc_template,(function(e,n){$("<option value='"+e+"'>"+n.name+"</option>").appendTo(i)})),$("#btn_start_form").bind("click",(function(e){e.stopPropagation(),e.preventDefault(),ig$.mi.getInstallStat()})),$("#btn_back_inst").bind("click",(function(e){e.stopPropagation(),e.preventDefault(),$("#dpage_01").show(),$("#dpage_02").hide(),$("#main-area").scrollTop(0)})),$("#btn_start_install").bind("click",(function(e){e.stopPropagation(),e.preventDefault(),ig$.mi.doUpdate()})),$("#btn_check_dburl").bind("click",(function(e){e.stopPropagation(),e.preventDefault(),ig$.mi.updateJdbcUrl()})),$("#btn_check_con").bind("click",(function(e){e.stopPropagation(),e.preventDefault(),ig$.mi.checkDatabaseCon()})),$("#btn_check_con2").bind("click",(function(e){e.stopPropagation(),e.preventDefault();var n=$("#db_isjndi").is(":checked");ig$.mi.checkDatabaseCon(n?["md_path"]:["md_user","md_password"],"db_con_status2")})),$("#btn_start").bind("click",(function(e){e.stopPropagation(),e.preventDefault(),goMain()})),$("#db_type").bind("change",(function(){ig$.mi.updateDesc()})),$("#db_isjndi").bind("change",(function(){ig$.mi.updateJNDI()})),ig$.mi.setLoading(!1),$.each(["db_host","db_port","db_name","db_user","db_path","md_owner","md_user"],(function(e,n){var t=$("#msg_"+n),i=$("#"+n);t.bind("click",(function(e){var n=t.text();n&&"Ex)"==n.substring(0,3)&&i.val(n.substring(4)||"")}))})),ig$.mi.updateDesc()}$(document).ready((function(){window.$instance={},init_events()}));
